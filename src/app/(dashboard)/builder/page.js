                ...
                <div className="bg-white dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/10 shadow-sm">
                    ...
                    {headerConfig.useCustomHeader ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                            <div><label className="text-[10px] font-bold text-gray-500 uppercase mb-1 block">Escola</label><input type="text" value={headerConfig.schoolName} onChange={(e) => setHeaderConfig({ ...headerConfig, schoolName: e.target.value })} className="w-full p-2 rounded-lg border border-gray-300 dark:border-white/10 text-sm" /></div>
                            <div><label className="text-[10px] font-bold text-gray-500 uppercase mb-1 block">Professor</label><input type="text" value={headerConfig.teacherName} onChange={(e) => setHeaderConfig({ ...headerConfig, teacherName: e.target.value })} className="w-full p-2 rounded-lg border border-gray-300 dark:border-white/10 text-sm" /></div>
                            <div><label className="text-[10px] font-bold text-gray-500 uppercase mb-1 block">Logo URL</label><input type="text" value={headerConfig.logoUrl} onChange={(e) => setHeaderConfig({ ...headerConfig, logoUrl: e.target.value })} className="w-full p-2 rounded-lg border border-gray-300 dark:border-white/10 text-sm" /></div>
                            <div className="flex gap-2 items-end">
                                <div className="flex-1"><label className="text-[10px] font-bold text-gray-500 uppercase mb-1 block">Turma</label><input type="text" value={headerConfig.className} onChange={(e) => setHeaderConfig({ ...headerConfig, className: e.target.value })} className="w-full p-2 rounded-lg border border-gray-300 dark:border-white/10 text-sm" /></div>
                                <div className="flex items-center gap-1 mb-2">
                                    <input type="checkbox" checked={headerConfig.showDate} onChange={(e) => setHeaderConfig({ ...headerConfig, showDate: e.target.checked })} /> <span className="text-xs">Data</span>
                                </div>
                            </div>
                        </div>
                    )}
