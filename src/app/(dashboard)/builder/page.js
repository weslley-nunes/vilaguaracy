...
export default function BuilderPage() {
    ...
    const saveExam = async () => {
        // Allow saving if it has collaborators, even if questions are 0 (for initial setup)
    ...
    const openExportModal = async (question) => {
    ...
    const generateSupportText = async () => {
            ...
            <div className="w-full md:w-1/3 bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col overflow-hidden relative">
                ...
                <div className="p-4 flex-1 overflow-y-auto custom-scrollbar pb-20">
                    <form onSubmit={(e) => generateQuestions(e, false)} className="mb-6 space-y-4">
                        ...
                        <div>
                            <label className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-1 block">Sobre o que é a questão?</label>
                            <input
                                type="text"
                                value={topic}
