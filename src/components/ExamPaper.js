...
const ExamPaper = forwardRef(({ questions, title, collaborators = [], headerConfig, showAnswers = false, isAdapted = false, scoringMode = "auto", totalScore = 3, onQuestionChange = null, onQuestionEdit = null, onQuestionDelete = null, onQuestionExport = null, printConfig = {} }, ref) => {
    ...
    const verbDictionary = {
        'analisar': 'Estude detalhadamente suas partes.',
        'analise': 'Estude detalhadamente suas partes.',
        'apontar': 'Indique ou especifique algo.',
        'aponte': 'Indique ou especifique algo.',
        'aplicar': 'Use o conhecimento em uma nova situação.',
        'aplique': 'Use o conhecimento em uma nova situação.',
        'avaliar': 'Julgue o valor ou a qualidade de algo.',
        'avalie': 'Julgue o valor ou a qualidade de algo.',
        'calcular': 'Determine o valor matematicamente.',
        'calcule': 'Determine o valor matematicamente.',
        'citar': 'Apresente informações sem detalhar.',
        'cite': 'Apresente informações sem detalhar.',
        'classificar': 'Agrupe de acordo com características.',
        'classifique': 'Agrupe de acordo com características.',
        'comparar': 'Examine semelhanças e diferenças.',
        'compare': 'Examine semelhanças e diferenças.',
        'completar': 'Preencha lacunas com informações.',
        'complete': 'Preencha lacunas com informações.',
        'compor': 'Junte partes para formar um todo.',
        'componha': 'Junte partes para formar um todo.',
        'conceituar': 'Dê a definição. Diga o que é.',
        'conceitue': 'Dê a definição. Diga o que é.',
        'concluir': 'Chegue a um resultado final.',
        'conclua': 'Chegue a um resultado final.',
        'construir': 'Forme, crie ou monte algo.',
        'construa': 'Forme, crie ou monte algo.',
        'contrastar': 'Mostre as diferenças entre itens.',
        'contraste': 'Mostre as diferenças entre itens.',
        'criar': 'Produza algo original ou novo.',
        'crie': 'Produza algo original ou novo.',
        'criticar': 'Analise e aponte méritos e falhas.',
        'critique': 'Analise e aponte méritos e falhas.',
        'defender': 'Apoie uma ideia com argumentos válidos.',
        'defenda': 'Apoie uma ideia com argumentos válidos.',
        'definir': 'Dê a definição. Diga o que é.',
        'defina': 'Dê a definição. Diga o que é.',
        'demonstrar': 'Prove ou mostre através de exemplos.',
        'demonstre': 'Prove ou mostre através de exemplos.',
        'descrever': 'Relate detalhes ou características.',
        'descreva': 'Relate detalhes ou características.',
        'diferenciar': 'Mostre características não iguais.',
        'diferencie': 'Mostre características não iguais.',
        'discutir': 'Apresente pontos de vista.',
        'discuta': 'Apresente pontos de vista.',
        'distinguir': 'Diferencie ou reconheça características.',
        'distinga': 'Diferencie ou reconheça características.',
        'enumerar': 'Atribua ou liste em ordem.',
        'enumere': 'Atribua ou liste em ordem.',
        'esboçar': 'Desenhe as linhas gerais (rascunho).',
        'esboce': 'Desenhe as linhas gerais (rascunho).',
        'exemplificar': 'Exemplos que deem forma ao conceito.',
        'exemplifique': 'Exemplos que deem forma ao conceito.',
        'explicar': 'Mostre como funciona ou o porquê.',
        'explique': 'Mostre como funciona ou o porquê.',
        'formular': 'Elabore ou expresse de forma clara.',
        'formule': 'Elabore ou expresse de forma clara.',
        'identificar': 'Reconheça e indique algo.',
        'identifique': 'Reconheça e indique algo.',
        'ilustrar': 'Esclareça com imagens ou exemplos.',
        'ilustre': 'Esclareça com imagens ou exemplos.',
        'inferir': 'Conclua a partir de evidências.',
        'infira': 'Conclua a partir de evidências.',
        'interpretar': 'Explique o significado ou sentido.',
        'interprete': 'Explique o significado ou sentido.',
        'investigar': 'Pesquise ou examine a fundo.',
        'investigue': 'Pesquise ou examine a fundo.',
        'julgar': 'Forme uma opinião baseada em fatos.',
        'julgue': 'Forme uma opinião baseada em fatos.',
        'justificar': 'Dê evidências, motivos ou fatos.',
        'justifique': 'Dê evidências, motivos ou fatos.',
        'listar': 'Relacione itens sequencialmente.',
        'liste': 'Relacione itens sequencialmente.',
        'nomear': 'Diga a forma como é chamado.',
        'nomeie': 'Diga a forma como é chamado.',
        'organizar': 'Estruture de forma sistemática.',
        'organize': 'Estruture de forma sistemática.',
        'planejar': 'Desenvolva um esquema ou roteiro.',
        'planeje': 'Desenvolva um esquema ou roteiro.',
        'propor': 'Apresente uma ideia para consideração.',
        'proponha': 'Apresente uma ideia para consideração.',
        'reconhecer': 'Lembre de informações já vistas.',
        'reconheça': 'Lembre de informações já vistas.',
        'relacionar': 'Conecte informações ou associe.',
        'relacione': 'Conecte informações ou associe.',
        'relatar': 'Conte ou narre um evento.',
        'relate': 'Conte ou narre um evento.',
        'reproduzir': 'Faça uma cópia ou replique.',
        'reproduza': 'Faça uma cópia ou replique.',
        'resolver': 'Encontre a resposta ou solução.',
        'resolva': 'Encontre a resposta ou solução.',
        'resumir': 'Sintetize as ideias principais.',
        'resuma': 'Sintetize as ideias principais.',
        'traduzir': 'Expresse em outra linguagem.',
        'traduza': 'Expresse em outra linguagem.',
        'escrever': 'Registre de forma textual.',
        'escreva': 'Registre de forma textual.',
        'esquematizar': 'Represente através de um esquema.',
        'esquematize': 'Represente através de um esquema.',
        'selecionar': 'Escolha com base em critérios.',
        'selecione': 'Escolha com base em critérios.',
        'assinalar': 'Marque ou indique uma opção.',
        'assinale': 'Marque ou indique uma opção.',
        'marcar': 'Indique ou faça um sinal.',
        'marque': 'Indique ou faça um sinal.'
    };
        ...
        <div ref={ref} className={`bg-white p-12 shadow-lg min-h-[1123px] w-[794px] mx-auto text-black print:shadow-none print:w-full relative ${isAdapted ? 'text-[22px]' : ''}`} style={fontStyle}>
            ...
            <div className="flex flex-row items-stretch gap-6 mb-6 w-full">
                ...
                <div className="flex-1 flex flex-col gap-4">
                    ...
                    {/* Tabela de Comandos - Only render if used */}
                    {usedVerbsList.length > 0 && (
                        <div className="w-full">
                            <table className={`w-full border-collapse border border-black ${isAdapted ? 'text-[12px] border-2' : 'text-[10px]'} text-left print:border-black`}>
                                <thead>
                                    <tr>
                                        <th colSpan="2" className="border border-black text-center font-bold uppercase py-1 bg-gray-100 print:bg-transparent print:border-black">Tabela de Comandos</th>
                                    </tr>
                                </thead>
                                <tbody>
                        ...
                        <div className="w-full flex justify-center gap-x-6">
                            {(() => {
                                ...
                                const renderColumn = (colItems, bIdx) => (
                                    <div key={bIdx} className={`border-t-2 border-black pt-1 flex flex-col gap-y-3 ${isAdapted ? 'w-[190px]' : 'w-[160px]'}`}>
